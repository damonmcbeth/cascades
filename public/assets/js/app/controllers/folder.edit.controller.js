(function() {
    ...
    FolderEditController.$inject = ['$scope', '$rootScope', '$state', '$q', '$filter', 'globalSettings', 
    	'globalNav', 'docService'];

    function FolderEditController($scope, $rootScope, $state, $q, $filter, globalSettings, globalNav, docService) {
        $scope.$state = $state;
